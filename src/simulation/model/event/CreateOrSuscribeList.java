...
/**
 * Subclass of event that represent when an user suscribes him in a list
 * 
 * @author Daniel Lara Diezma
 * @email daniel.lara.diezma@gmail.com
 *
 */
public class CreateOrSuscribeList extends Event{

	public CreateOrSuscribeList(String name, String timeStamp) {
