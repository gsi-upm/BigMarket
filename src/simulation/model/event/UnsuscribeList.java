...
/**
 * Subclass of event that represents the action of unsuscribe from a list
 * 
 ...
 *
 */
public class UnsuscribeList extends CreateOrSuscribeList{

	public UnsuscribeList(String name, String timeStamp) {
